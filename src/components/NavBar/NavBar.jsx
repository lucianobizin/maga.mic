            ...
            <div className="navbar-right">
                ...
                <nav className={openNavbar ? 'open' : ''}>
                    ...
                    <ul>
                        ...
                        <li className="nav-links" onClick={openMenu}><NavLink to={`/category/DiceAndRunes`}>DiceAndRunes</NavLink></li>
                        <li className="nav-links" onClick={openMenu}><NavLink to={`/category/Event`}>Event</NavLink></li>
                        <li className="nav-links" onClick={openMenu}><NavLink to={`/category/Products`}>Products</NavLink></li>
                        <li className="nav-links" onClick={openMenu}><NavLink to={`/category/Workshops`}>Workshops</NavLink></li>
                        <li className="nav-links" onClick={openMenu}><NavLink to={`/category/Tarot`}>Tarot</NavLink></li>
                    </ul>
                </nav>
